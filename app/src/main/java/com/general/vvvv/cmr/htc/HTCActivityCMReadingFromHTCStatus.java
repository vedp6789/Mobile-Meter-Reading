 ...
 */
public class HTCActivityCMReadingFromHTCStatus extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readingUpdate = false;
        dbHTCReading = new DbHTCReading(HTCActivityCMReadingFromHTCStatus.this, DbHTCReading.DB_NAME, null, DbHTCReading.DB_VERSION);
        sqLiteDatabase = dbHTCReading.getReadableDatabase();
        sqLiteDatabase.close();

        contentValues = new ContentValues();
        appLocationService = new AppLocationService(HTCActivityCMReadingFromHTCStatus.this);


        dbLogin = new DbLogin(HTCActivityCMReadingFromHTCStatus.this, DbLogin.DB_NAME, null, DbLogin.DB_VERSION);
        ...
        String main_meter_status = bundle.getString("STATUS_MM");
        ...
        if (main_meter_status.equals(a)) {

            sp_meter_status_ht.setSelection(0);
            s_meter_status_ht = "NORMAL";
            String m_type = bundle.getString("TYPE_MM"), rem = bundle.getString("REMARKS_MM");
            s_meter_type_ht = m_type;
            s_remarks_ht = rem;

            int type_index = Arrays.asList(type).indexOf(m_type);
            int rem_index = Arrays.asList(remarks).indexOf(rem);
            sp_meter_type_ht.setSelection(type_index);
            sp_remark_ht.setSelection(rem_index);

            if (bundle.getString("KW_MM") != null) {
                et_kw_ht.setText(bundle.getString("KW_MM"));
            }
            if (bundle.getString("KVA_MM") != null) {
                et_kva_ht.setText(bundle.getString("KVA_MM"));
            }
            if (bundle.getString("KWH_MM") != null) {
                et_kwh_ht.setText(bundle.getString("KWH_MM"));
            }
            if (bundle.getString("KVAH_MM") != null) {
                et_kvah_ht.setText(bundle.getString("KVAH_MM"));
            }
            if (bundle.getString("KVARH_MM") != null) {
                et_kvarh_ht.setText(bundle.getString("KVARH_MM"));
            }
            if (bundle.getString("REMARK1_MM") != null) {
                String remNA="NA";
                if(bundle.getString("REMARK1_MM").equals(remNA)){

                }else{
                    et_rem_1_ht.setText(bundle.getString("REMARK1_MM"));
                }

            }

        } else {
            if (main_meter_status.equals(b)) {
                sp_meter_status_ht.setSelection(1);
                s_meter_status_ht = bundle.getString("STATUS_MM");
                String m_type = bundle.getString("TYPE_MM"), rem = bundle.getString("REMARKS_MM");
                s_meter_type_ht = m_type;
                s_remarks_ht = rem;
                ...
                if (main_meter_status.equals(c)) {
                    sp_meter_status_ht.setSelection(3);
                    s_meter_status_ht = bundle.getString("STATUS_MM");
                    String m_type = bundle.getString("TYPE_MM"), rem = bundle.getString("REMARKS_MM");
                    s_meter_type_ht = m_type;
                    s_remarks_ht = rem;
                    ...
                    String stat=bundle.getString("STATUS_MM");
                    int stat_index=Arrays.asList(status).indexOf(stat);
                    sp_meter_status_ht.setSelection(stat_index);
                    s_meter_status_ht = bundle.getString("STATUS_MM");
                    String m_type = bundle.getString("TYPE_MM"), rem = bundle.getString("REMARKS_MM");
                    s_meter_type_ht = m_type;
                    s_remarks_ht = rem;
        ...
        b_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                                    ...
                                    if ((et_kvah_ht.getText().length() != 0)) {
                                        if ((et_kvarh_ht.getText().length() != 0)) {
                                            if ((et_kwh_lt.getText().length() != 0)) {
                                                ...
                                                Toast.makeText(HTCActivityCMReadingFromHTCStatus.this, "Kindly insert the meter reading for KWH Check meter.", Toast.LENGTH_LONG).show();
                                            }

                                        } else {
                                            Toast.makeText(HTCActivityCMReadingFromHTCStatus.this, "Kindly insert the meter reading for KVARH Main meter.", Toast.LENGTH_LONG).show();
                                        }

                                    } else {
                                        Toast.makeText(HTCActivityCMReadingFromHTCStatus.this, "Kindly insert the meter reading for KVAH Main meter.", Toast.LENGTH_LONG).show();
                                    }
                                } else {
                                    Toast.makeText(HTCActivityCMReadingFromHTCStatus.this, "Kindly insert the meter reading for KWH Main meter.", Toast.LENGTH_LONG).show();
                                }

                            } else {
                                Toast.makeText(HTCActivityCMReadingFromHTCStatus.this, "Kindly insert the meter reading for KVA Main meter.", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Toast.makeText(HTCActivityCMReadingFromHTCStatus.this, "Kindly insert the meter reading for KW Main meter.", Toast.LENGTH_LONG).show();
                        }
                        can_be_saved = false;
                    }
                }else{
                ...
                if (readingUpdate) {
                    ...
                    Toast.makeText(HTCActivityCMReadingFromHTCStatus.this, "Local database get successfully updated !", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(HTCActivityCMReadingFromHTCStatus.this, "Problem in updating local database !\n"+"Crosscheck your meter reading.", Toast.LENGTH_SHORT).show();
                }
    ...
    void localDatabaseUpdate() {
        ...
        if ((s_meter_status_ht.equals("LOCK")) || (s_meter_status_ht.equals("NO METER")) || (s_meter_status_ht.equals("POWER OFF")) || (s_meter_status_ht.equals("NO DISPLAY"))) {
            Toast.makeText(HTCActivityCMReadingFromHTCStatus.this, s_meter_status_ht + " status found.", Toast.LENGTH_SHORT).show();
        ...
        if ((s_meter_status_lt.equals("LOCK")) || (s_meter_status_lt.equals("NO METER")) || (s_meter_status_lt.equals("POWER OFF")) || (s_meter_status_lt.equals("NO DISPLAY"))) {
            Toast.makeText(HTCActivityCMReadingFromHTCStatus.this, s_meter_status_lt + " status found.", Toast.LENGTH_SHORT).show();
            //contentValues.put(DbConnection.METER_READING,"");
        ...
        dbHTCReading.updateReadingDetails3(contentValues, consumer_id);

    }

    public void alertMessage(String provider) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                HTCActivityCMReadingFromHTCStatus.this);
        ...
        alertDialog.setPositiveButton("Settings",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        HTCActivityCMReadingFromHTCStatus.this.startActivity(intent);
                    }
                });
