 ...
 */
public class HtcActivityReadingForConsumerList extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readingUpdate = false;
        dbHTCReading = new DbHTCReading(HtcActivityReadingForConsumerList.this, DbHTCReading.DB_NAME, null, DbHTCReading.DB_VERSION);
        sqLiteDatabase = dbHTCReading.getReadableDatabase();
        sqLiteDatabase.close();

        contentValues = new ContentValues();
        appLocationService = new AppLocationService(HtcActivityReadingForConsumerList.this);


        dbLogin = new DbLogin(HtcActivityReadingForConsumerList.this, DbLogin.DB_NAME, null, DbLogin.DB_VERSION);
        ...
        consumer_id = getIntent().getExtras().getInt("HTC");
...
//////////////////////////////////////////////////////////////////////////////////////////On Commit to local database//////////////////////////////////////////////////
        b_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                                    ...
                                    if ((et_kvah_ht.getText().length() != 0)) {
                                        if ((et_kvarh_ht.getText().length() != 0)) {
                                            if ((et_kwh_lt.getText().length() != 0)) {
                                                ...
                                                Toast.makeText(HtcActivityReadingForConsumerList.this, "Kindly insert the meter reading for KWH Check meter.", Toast.LENGTH_LONG).show();
                                            }

                                        } else {
                                            Toast.makeText(HtcActivityReadingForConsumerList.this, "Kindly insert the meter reading for KVARH Main meter.", Toast.LENGTH_LONG).show();
                                        }

                                    } else {
                                        Toast.makeText(HtcActivityReadingForConsumerList.this, "Kindly insert the meter reading for KVAH Main meter.", Toast.LENGTH_LONG).show();
                                    }
                                } else {
                                    Toast.makeText(HtcActivityReadingForConsumerList.this, "Kindly insert the meter reading for KWH Main meter.", Toast.LENGTH_LONG).show();
                                }

                            } else {
                                Toast.makeText(HtcActivityReadingForConsumerList.this, "Kindly insert the meter reading for KVA Main meter.", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Toast.makeText(HtcActivityReadingForConsumerList.this, "Kindly insert the meter reading for KW Main meter.", Toast.LENGTH_LONG).show();
                        }
                        can_be_saved = false;
                    }
                }else{
                ...
                if (readingUpdate) {
                    ...
                    Toast.makeText(HtcActivityReadingForConsumerList.this, "Local database get successfully updated !", Toast.LENGTH_SHORT).show();
                    if(dbHTCReading.noOfConForReading(area_code)){
                        Intent intent =new Intent(HtcActivityReadingForConsumerList.this,HtcActivityAreaConsumerList.class);
                    ...
                    Toast.makeText(HtcActivityReadingForConsumerList.this, "Problem in updating local database !\n"+"Crosscheck your meter reading.", Toast.LENGTH_SHORT).show();
                }
    ...
    void localDatabaseUpdate() {
        ...
        if ((s_meter_status_ht.equals("LOCK")) || (s_meter_status_ht.equals("NO METER")) || (s_meter_status_ht.equals("POWER OFF")) || (s_meter_status_ht.equals("NO DISPLAY"))) {
            Toast.makeText(HtcActivityReadingForConsumerList.this, s_meter_status_ht + " status found.", Toast.LENGTH_SHORT).show();
        ...
        if ((s_meter_status_lt.equals("LOCK")) || (s_meter_status_lt.equals("NO METER")) || (s_meter_status_lt.equals("POWER OFF")) || (s_meter_status_lt.equals("NO DISPLAY"))) {
            Toast.makeText(HtcActivityReadingForConsumerList.this, s_meter_status_lt + " status found.", Toast.LENGTH_SHORT).show();
            //contentValues.put(DbConnection.METER_READING,"");
        ...
        dbHTCReading.updateReadingDetails1(contentValues, consumer_id);

    }

    public void alertMessage(String provider) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                HtcActivityReadingForConsumerList.this);
        ...
        alertDialog.setPositiveButton("Settings",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        HtcActivityReadingForConsumerList.this.startActivity(intent);
                    }
                });
