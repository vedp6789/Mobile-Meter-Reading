 ...
 */
public class HtcActivityReading extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("HtcActivityReading onCreate");
        init();

        readingUpdate = false;
        dbHTCReading = new DbHTCReading(HtcActivityReading.this, DbHTCReading.DB_NAME, null, DbHTCReading.DB_VERSION);
        sqLiteDatabase = dbHTCReading.getReadableDatabase();
        sqLiteDatabase.close();

        contentValues = new ContentValues();
        appLocationService = new AppLocationService(HtcActivityReading.this);


        dbLogin = new DbLogin(HtcActivityReading.this, DbLogin.DB_NAME, null, DbLogin.DB_VERSION);
        ...
        consumer_id = Integer.parseInt(getIntent().getExtras().getString("CONSUMER_ID"));
...
//////////////////////////////////////////////////////////////////////////////////////////On Commit to local database//////////////////////////////////////////////////
        b_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                                    ...
                                    if ((et_kvah_ht.getText().length() != 0)) {
                                        if ((et_kvarh_ht.getText().length() != 0)) {
                                            if ((et_kwh_lt.getText().length() != 0)) {
                                                ...
                                                Toast.makeText(HtcActivityReading.this, "Kindly insert the meter reading for KWH Check meter.", Toast.LENGTH_LONG).show();
                                            }

                                        } else {
                                            Toast.makeText(HtcActivityReading.this, "Kindly insert the meter reading for KVARH Main meter.", Toast.LENGTH_LONG).show();
                                        }

                                    } else {
                                        Toast.makeText(HtcActivityReading.this, "Kindly insert the meter reading for KVAH Main meter.", Toast.LENGTH_LONG).show();
                                    }
                                } else {
                                    Toast.makeText(HtcActivityReading.this, "Kindly insert the meter reading for KWH Main meter.", Toast.LENGTH_LONG).show();
                                }

                            } else {
                                Toast.makeText(HtcActivityReading.this, "Kindly insert the meter reading for KVA Main meter.", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Toast.makeText(HtcActivityReading.this, "Kindly insert the meter reading for KW Main meter.", Toast.LENGTH_LONG).show();
                        }
                        can_be_saved = false;
                    }
                }else{
                ...
                if (readingUpdate) {
                    ...
                    Toast.makeText(HtcActivityReading.this, "Local database get successfully updated !", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(HtcActivityReading.this, "Problem in updating local database !\n"+"Crosscheck your meter reading.", Toast.LENGTH_SHORT).show();
                }
    ...
    void localDatabaseUpdate() {
        ...
        if ((s_meter_status_ht.equals("LOCK")) || (s_meter_status_ht.equals("NO METER")) || (s_meter_status_ht.equals("POWER OFF")) || (s_meter_status_ht.equals("NO DISPLAY"))) {
            Toast.makeText(HtcActivityReading.this, s_meter_status_ht + " status found.", Toast.LENGTH_SHORT).show();
        ...
        if ((s_meter_status_lt.equals("LOCK")) || (s_meter_status_lt.equals("NO METER")) || (s_meter_status_lt.equals("POWER OFF")) || (s_meter_status_lt.equals("NO DISPLAY"))) {
            Toast.makeText(HtcActivityReading.this, s_meter_status_lt + " status found.", Toast.LENGTH_SHORT).show();
            //contentValues.put(DbConnection.METER_READING,"");
        ...
        dbHTCReading.updateReadingDetails(contentValues, consumer_id);

    }

    public void alertMessage(String provider) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                HtcActivityReading.this);
        ...
        alertDialog.setPositiveButton("Settings",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        HtcActivityReading.this.startActivity(intent);
                    }
                });
    ...
    protected void onStart() {
        super.onStart();
        System.out.println("HtActivityReading onStart");
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        System.out.println("HtActivityReading onRestart");
    }

    @Override
    protected void onResume() {
        super.onResume();
        System.out.println("HtActivityReading onResume");
    }

    @Override
    protected void onPause() {
        super.onPause();
        System.out.println("HtActivityReading onPause");
    }

    @Override
    protected void onStop() {
        super.onStop();
        System.out.println("HtActivityReading onStop");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        System.out.println("HtActivityReading onDestroy");
    }
}
