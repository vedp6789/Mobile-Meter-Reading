 ...
 */
public class LtpActivityReading extends ActionBarActivity {
        ...
        alertDialog.setPositiveButton("Settings",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        LtpActivityReading.this.startActivity(intent);
                    }
                });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ltp_reading);
        System.out.println("LtpActivityReading onCrate");

        init();


        readingUpdate = false;
        dbLTPReading = new DbLTPReading(LtpActivityReading.this, DbLTPReading.DB_NAME, null, DbLTPReading.DB_VERSION);
        sqLiteDatabase = dbLTPReading.getReadableDatabase();
        sqLiteDatabase.close();

        contentValues = new ContentValues();
        appLocationService = new AppLocationService(LtpActivityReading.this);


        dbLogin = new DbLogin(LtpActivityReading.this, DbLogin.DB_NAME, null, DbLogin.DB_VERSION);
...
//////////////////////////////////////////////////////////////////////////////////////////On Commit to local database//////////////////////////////////////////////////
        b_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                                ...
                                if ((et_kwh.getText().length() != 0)) {
                                    if ((et_kvah.getText().length() != 0)) {
                                        if ((et_kvarh.getText().length() != 0)) {
                                            ...
                                            Toast.makeText(LtpActivityReading.this, "Kindly insert the meter reading for KVARH.", Toast.LENGTH_LONG).show();
                                        }

                                    } else {
                                        Toast.makeText(LtpActivityReading.this, "Kindly insert the meter reading for KVAH.", Toast.LENGTH_LONG).show();
                                    }
                                } else {
                                    Toast.makeText(LtpActivityReading.this, "Kindly insert the meter reading for KWH.", Toast.LENGTH_LONG).show();
                                }

                            } else {
                                Toast.makeText(LtpActivityReading.this, "Kindly insert the meter reading for KVA.", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Toast.makeText(LtpActivityReading.this, "Kindly insert the meter reading for KW.", Toast.LENGTH_LONG).show();
                        }
                        can_be_saved = false;
                    }
                } else {
                ...
                if (readingUpdate) {
                    ...
                    Toast.makeText(LtpActivityReading.this, "Local database get successfully updated !", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(LtpActivityReading.this, "Problem in updating local database !\n" + "Crosscheck your meter reading.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    void localDatabaseUpdate() {
        ...
        if ((s_meter_status.equals("LOCK")) || (s_meter_status.equals("NO METER")) || (s_meter_status.equals("POWER OFF")) || (s_meter_status.equals("NO DISPLAY"))) {
            Toast.makeText(LtpActivityReading.this, s_meter_status + " status found.", Toast.LENGTH_SHORT).show();
        ...
        dbLTPReading.updateReadingDetails(contentValues, consumer_id);
    ...
    protected void onStart() {
        super.onStart();
        System.out.println("LtActivityReading onStart");
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        System.out.println("LtActivityReading onRestart");
    }

    @Override
    protected void onResume() {
        super.onResume();
        System.out.println("LtActivityReading onResume");
    }

    @Override
    protected void onPause() {
        super.onPause();
        System.out.println("LtActivityReading onPause");
    }

    @Override
    protected void onStop() {
        super.onStop();
        System.out.println("LtActivityReading onStop");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        System.out.println("LtActivityReading onDestroy");
    }
}
