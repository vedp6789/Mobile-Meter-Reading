 ...
 */
public class LtpExpandableAdapter implements ExpandableListAdapter {
    Context _context;
    private List<String> _listDataHeader; // header titles
    // child data in format of header title, child title
    private HashMap<String, ArrayList<PojoDownload>> _listDataChild;

    public LtpExpandableAdapter(Context context, List<String> listDataHeader,
...
//        }whi*/le (iterator.hasNext());
                ...
                if (groupPosition == 2) {
                    ...
                    if (convertView == null) {
                        ...
                        TextView tv_ltp = (TextView) convertView.findViewById(R.id.tv_ltp_no);



                        tv_area3.setText(area_code);
                        tv_ltp.setText(ltp_no.toString());
