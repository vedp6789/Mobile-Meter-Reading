 ...
 */
public class DbHtcDownloadStatus extends SQLiteOpenHelper {
    public static String DB_NAME="HTC_DOWNLOAD_STATUS_DB";
    public static String TB_NAME="HTC_DOWNLOAD_STATUS_TB";
    ...
    public DbHtcDownloadStatus(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
